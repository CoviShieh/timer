define(['base','GXX','layer'],function(base,Gxx,layer){
...
//		_edit:function(row){
//			var that = this,
//				url = visitingUnitUrl.setVisitingUnit;
//				
//			editWin = dialog({
//		 		title: '更新被访单位信息',
//	 			width:600,
//	 			content:$(".curdBox"),
//	 			onshow: function(){
//	 				$("#f_userId").val(row.accountName);
//					$("#f_unitName").val(row.unitName);
//					$("#f_telNum").val(row.telNum);
//					$("#f_roomNum").val(row.unitLocation);
//	 			},
//				onclose: function(){
//					$(".curdbox").css('display','none');
//					this.close();
...
//					    	var data = {
//					    	id: row.id,
//					    	accountName: $("#f_userId").val(),
//					    	unitName: $("#f_unitName").val(),
//					    	telNum: $("#f_telNum").val(),
//					    	unitLocation: $("#f_roomNum").val()
//					    	};
//					   	 	if(tableOpe._validater()){
//					   	 		var i=0;
//					   	 		$.ajax({
